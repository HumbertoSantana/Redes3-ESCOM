...
contendio_original = os.listdir("/var/log/10.1.2.2")
...
while 1:
    ...
    contenido_nuevo = os.listdir("/var/log/10.1.2.2")
    ...
    if tamanio_or != tamanio_nuevo:
        ...
        if tamanio_or == 0:
            ...
            while recorrido != diferencia:
                ...
                archivo_syslog = open(r"/var/log/10.1.2.2/" + contenido_nuevo[recorrido], "r")
